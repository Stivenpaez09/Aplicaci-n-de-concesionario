...
public class CargarVehiculo extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        control.guardarDatos(txtModelo.getText(), txtAnio.getText(), txtMotor.getText(), txtColor.getText(), txtPlaca.getText(), (String)cmbPuerta.getSelectedItem());
        JOptionPane.showMessageDialog(null, "Se ha guardado con exito el vehiculo", "Vehiculo Guardado", JOptionPane.INFORMATION_MESSAGE);
